...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 09, 2013 at 10:32 PM
...
CREATE TABLE IF NOT EXISTS `course` (
  ...
  KEY `fk_Course_User1_idx` (`fkUser`)
...
INSERT INTO `course` (`ID`, `fkDepartment`, `fkUser`, `name`, `description`, `prefix`, `number`, `dateCreated`, `dateModified`, `status`) VALUES
...
(76, 1, 1, 'Introduction to Algorithmic Design I', 'Easy class. Used to weed out the students who can''t learn how to program.', 'CSCI', '130', '2013-07-09 16:17:35', '2013-07-09 16:17:35', 1),
(77, 1, 1, 'Introduction to Algorithmic Design II', 'Still easy class. Still used to weed out students who can''t learn how to program.', 'CSCI', '140', '2013-07-09 16:18:12', '2013-07-09 16:18:12', 1),
(78, 1, 1, 'Data Structures', 'Hard class. Math heavy.', 'CSCI', '220', '2013-07-09 16:18:33', '2013-07-09 16:18:33', 1),
(79, 1, 1, 'Introduction to Algorithmic Design III', 'Slightly harder.', 'CSCI', '150', '2013-07-09 16:19:36', '2013-07-09 16:19:36', 1);
...
CREATE TABLE IF NOT EXISTS `objective` (
  ...
  KEY `fk_Objective_User1_idx` (`fkUser`)
...
CREATE TABLE IF NOT EXISTS `slo` (
  ...
  KEY `fk_SLO_Department1_idx` (`fkDepartment`)
...
(1, NULL, 'Aaron', 'Smith', 'ajsmith7', '$2a$08$kPS/eZyFooCIdNJgkze/tODvTfDS20D/qK5tO5BeOS6Y0YdyAH.8akPS/eZyFooCIdNJgkze/tS', 3, '2013-07-09 15:36:06', 1),
...
ALTER TABLE `course`
  ...
  ADD CONSTRAINT `fk_Course_User1` FOREIGN KEY (`fkUser`) REFERENCES `user` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `objective`
  ...
  ADD CONSTRAINT `fk_Objective_User1` FOREIGN KEY (`fkUser`) REFERENCES `user` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
--
ALTER TABLE `slo`
  ADD CONSTRAINT `fk_SLO_Department1` FOREIGN KEY (`fkDepartment`) REFERENCES `department` (`ID`) ON DELETE NO ACTION ON UPDATE NO ACTION;
